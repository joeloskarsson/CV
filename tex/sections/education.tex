...
\item [2020--2025] \textbf{Doctoral Studies in Computer Science}\\
        Linköping University, 240 ECTS\\
        {\footnotesize Linköping, Sweden}
        \begin{itemize}
            \item PhD thesis: \textit{Modeling Spatio-Temporal Systems with Graph-based Machine Learning}.
        ...
        \end{itemize}
    \item [2015--2020]
        \textbf{Master's program in Computer Science and Engineering}\\%(Swedish Civilingenjörsprogram)
    ...
    \item [2018--2019] \textbf{Exchange Studies}\\
        ETH Zurich\\
        {\footnotesize Zurich, Switzerland}\\
