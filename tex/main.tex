...
\begin{itemize}
    \item \text{
        ...
        \text{
            ...
            Kurser på kandidatnivå inom matematik, mjukvaruutveckling och hårdvara. Masterprofil inom artificiell intelligens och maskininlärning.
        }
        \begin{itemize}
            \item \text{
...
\begin{itemize}
    \item \text{Programming Languages and Frameworks}{Programmeringsspråk och ramverk}
        \begin{description}
            ...
            \item [\text{Experience with}{Erfarenhet av}] SciPy, scikit-learn, R, Tensorflow, PyTorch, Android, Unity, SQL, MATLAB, Travis CI, \text{and}{och} C.
        \end{description}
    \item \text{
